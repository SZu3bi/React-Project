...
<div className="contenttextheadercard">
<span style={{    color: 'green'}} className="mdi mdi-map-marker-outline px-2" />    
<span>Amman Bayder</span>
    </div>
<div className="contenttextheadercard">
<span style={{    color: 'red'}} className="mdi mdi-map-marker-outline px-2" />
<span>Amman-Bayder</span>
    </div>
<div className="contenttextheadercard">
...
,color: 'orange',fontWeight:'600'}}>1100 AED</div>
    ...
    <Button
                className="btns theme-outline">Continue to payment
            </Button>
    </div>
    </div>

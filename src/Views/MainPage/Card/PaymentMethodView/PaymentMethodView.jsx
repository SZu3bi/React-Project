...
export const PaymentMethodView = ()=>{
    ...
    return(
        ...
        <div className="users-card-wrapperpayment" >
            ...
            <p className="headertitle">Payment Method {credit.creditcard ? creditlabel : null}{paypal.payPal ?paypallabel:null}</p> 
        </div>
...
<div>
<div className="textfieldlabel textfieldlabel-top">Card holder name</div>
                <div className="textfield">
                <Inputs
                idRef="tripsSearchRef"
                variant="outlined"
...
<div className="textfieldlabel textfieldlabel-top">Date</div>
        ...
        <Button
                className="continuepayment">Continue
            </Button>
        </div>
        </div>
            </div>
